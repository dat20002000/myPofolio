...
function getProjectInfor(id) {
    Object.keys(jData).forEach(function (key) {
        if (id == key){
            document.getElementById('projectLabel').innerHTML = jData[key].name;
            document.getElementById('projectDate').innerHTML = jData[key].date;
            document.getElementById('projDes').innerHTML = jData[key].projectDescription;
            document.getElementById('resp').innerHTML = jData[key].responsibilities;
            document.getElementById('tech').innerHTML = jData[key].technologies;
            document.getElementById('roleM').innerHTML = jData[key].role;
            document.getElementById('teamSize').innerHTML = jData[key].teamSize;
        }
    })
}
